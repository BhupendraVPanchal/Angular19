...
export class CompanyComponent implements OnInit, AfterViewInit {
  ...
  grid_config: any = {
    title:'<h5 class="mb-0">Company Master</h5>',
    grid_name: 'company',
    is_addbtn: false,
    full_width: true,
    grid_class: '',
  ...
  public init() {
    ...
    this.query = {
      page_number: 1,
      page_size: 20,
      search_column: 'companyid',
      search_text: '',
      sort_col_name: 'companyid',
      sort_type: 'Desc'
    };
    this.data_items = [];
  }
  ...
  public add_edit_record(_entity_code: string): void {
    let dialogRef = this._dialog.open(CompanyAddEditComponent, { data: { entity_code: _entity_code }, panelClass: 'mid-width' });
