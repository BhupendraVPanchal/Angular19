...
export class CompanyAddEditComponent implements OnInit {
  ...
  public form_title: string = "Add Company";
  ...
  build_form(rowdata: any) {
    ...
    this.entity_formgroup = this.fb.group(
      {
        companyid: [rowdata != null ? rowdata.companyid : 0],
        companyname: [rowdata != null ? rowdata.companyname : null],
        alias: [rowdata != null ? rowdata.alias : null],
        address: [rowdata != null ? rowdata.address : null],
        countryid: [rowdata != null ? rowdata.countryid : null],
        stateid: [rowdata != null ? rowdata.stateid : 0],
        cityid: [rowdata != null ? rowdata.cityid : 0],
        zipcode: [rowdata != null ? rowdata.zipcode : 0],
        contactno: [rowdata != null ? rowdata.contactno : null],
        email: [rowdata != null ? rowdata.email : null],
        logo: [rowdata != null ? rowdata.logo : null],
        note: [rowdata != null ? rowdata.note : null],
        website: [rowdata != null ? rowdata.website : null],
        pan: [rowdata != null ? rowdata.pan : ''],
        is_locked: [rowdata != null ? rowdata.is_locked : 0]
      }
    );
  ...
  private loadCountries(): void {
    this._commonservice.GetLocationData({ ParentID: null }).subscribe((res: any) => {
  ...
  save_entity_data(): void {
    ...
    this._masterserviceobj.add_update_companymaster(snd_data)
      .subscribe({
        next: (data) => {
